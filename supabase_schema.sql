...
-- Add cache tracking fields to sessions
ALTER TABLE sessions ADD COLUMN IF NOT EXISTS billable_tokens INTEGER DEFAULT 0;
ALTER TABLE sessions ADD COLUMN IF NOT EXISTS cache_discount REAL DEFAULT 0.0;
ALTER TABLE sessions ADD COLUMN IF NOT EXISTS response_time_avg REAL;
ALTER TABLE sessions ADD COLUMN IF NOT EXISTS error_count INTEGER DEFAULT 0;

-- Add billable_tokens to five_hour_blocks
ALTER TABLE five_hour_blocks ADD COLUMN IF NOT EXISTS billable_tokens INTEGER DEFAULT 0;
ALTER TABLE five_hour_blocks ADD COLUMN IF NOT EXISTS cache_creation_tokens INTEGER DEFAULT 0;
ALTER TABLE five_hour_blocks ADD COLUMN IF NOT EXISTS cache_read_tokens INTEGER DEFAULT 0;
